...
public class SelectorTest {
    @Test public void testByTag() {
        Elements els = Zsoup.parse("<div id=1><div id=2><p>Hello</p></div></div><div id=3>").select("div");
        assertEquals(3, els.size());
        assertEquals("1", els.get(0).id());
        assertEquals("2", els.get(1).id());
        assertEquals("3", els.get(2).id());

        Elements none = Zsoup.parse("<div id=1><div id=2><p>Hello</p></div></div><div id=3>").select("span");
        assertEquals(0, none.size());
    }

    @Test public void testById() {
        Elements els = Zsoup.parse("<div><p id=foo>Hello</p><p id=foo>Foo two!</p></div>").select("#foo");
        assertEquals(2, els.size());
        assertEquals("Hello", els.get(0).text());
        assertEquals("Foo two!", els.get(1).text());

        Elements none = Zsoup.parse("<div id=1></div>").select("#foo");
        assertEquals(0, none.size());
    }

    @Test public void testByClass() {
        Elements els = Zsoup.parse("<p id=0 class='one two'><p id=1 class='one'><p id=2 class='two'>").select("p.one");
        assertEquals(2, els.size());
        assertEquals("0", els.get(0).id());
        assertEquals("1", els.get(1).id());

        Elements none = Zsoup.parse("<div class='one'></div>").select(".foo");
        assertEquals(0, none.size());

        Elements els2 = Zsoup.parse("<div class='One-Two'></div>").select(".one-two");
    ...
    @Test public void testNamespacedTag() {
        Document doc = Zsoup.parse("<div><abc:def id=1>Hello</abc:def></div> <abc:def class=bold id=2>There</abc:def>");
    ...
    @Test public void testByAttributeStarting() {
        Document doc = Zsoup.parse("<div id=1 data-name=jsoup>Hello</div><p data-val=5 id=2>There</p><p id=3>No</p>");
    ...
    @Test public void testByAttributeRegex() {
        Document doc = Zsoup.parse("<p><img src=foo.png id=1><img src=bar.jpg id=2><img src=qux.JPEG id=3><img src=old.gif><img></p>");
    ...
    @Test public void testByAttributeRegexCharacterClass() {
        Document doc = Zsoup.parse("<p><img src=foo.png id=1><img src=bar.jpg id=2><img src=qux.JPEG id=3><img src=old.gif id=4></p>");
    ...
    @Test public void testByAttributeRegexCombined() {
        Document doc = Zsoup.parse("<div><table class=x><td>Hello</td></table></div>");
    ...
    @Test public void testCombinedWithContains() {
        Document doc = Zsoup.parse("<p id=1>One</p><p>Two +</p><p>Three +</p>");
    ...
    @Test public void testGroupOrAttribute() {
        ...
        Elements els = Zsoup.parse(h).select("[id],[title=foo]");
    ...
    @Test public void deeperDescendant() {
        ...
        Elements els = Zsoup.parse(h).select("div p .first");
        assertEquals(1, els.size());
    ...
    @Test public void testPseudoLessThan() {
        Document doc = Zsoup.parse("<div><p>One</p><p>Two</p><p>Three</>p></div><div><p>Four</p>");
    ...
    @Test public void testPseudoCombined() {
        Document doc = Zsoup.parse("<div class='foo'><p>One</p><p>Two</p></div><div><p>Three</p><p>Four</p></div>");
    ...
    @Test public void testPseudoHas() {
        Document doc = Zsoup.parse("<div id=0><p><span>Hello</span></p></div> <div id=1><span class=foo>There</span></div> <div id=2><p>Not</p></div>");
    ...
    @Test public void testNestedHas() {
        Document doc = Zsoup.parse("<div><p><span>One</span></p></div> <div><p>Two</p></div>");
    ...
    @Test public void testPseudoContains() {
        Document doc = Zsoup.parse("<div><p>The Rain.</p> <p class=light>The <i>rain</i>.</p> <p>Rain, the.</p></div>");
    ...
    @Test public void testPsuedoContainsWithParentheses() {
        Document doc = Zsoup.parse("<div><p id=1>This (is good)</p><p id=2>This is bad)</p>");
    ...
    @Test public void containsOwn() {
        Document doc = Zsoup.parse("<p id=1>Hello <b>there</b> now</p>");
    ...
    @Test public void testMatches() {
        Document doc = Zsoup.parse("<p id=1>The <i>Rain</i></p> <p id=2>There are 99 bottles.</p> <p id=3>Harder (this)</p> <p id=4>Rain</p>");
    ...
    @Test public void testRelaxedTags() {
        Document doc = Zsoup.parse("<abc_def id=1>Hello</abc_def> <abc-def id=2>There</abc-def>");
    ...
    @Test public void notParas() {
        Document doc = Zsoup.parse("<p id=1>One</p> <p>Two</p> <p><span>Three</span></p>");
    ...
    @Test public void notAll() {
        Document doc = Zsoup.parse("<p>Two</p> <p><span>Three</span></p>");
    ...
    @Test public void notClass() {
        Document doc = Zsoup.parse("<div class=left>One</div><div class=right id=1><p>Two</p></div>");
    ...
    @Test public void handlesCommasInSelector() {
        Document doc = Zsoup.parse("<p name='1,2'>One</p><div>Two</div><ol><li>123</li><li>Text</li></ol>");
    ...
    @Test public void selectSupplementaryCharacter() {
        ...
        Document doc = Zsoup.parse("<div k" + s + "='" + s + "'>^" + s +"$/div>");
