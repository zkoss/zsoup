...
public class ElementsTest {
    ...
    @Test public void hasAttr() {
        Document doc = Zsoup.parse("<p title=foo><p title=bar><p class=foo><p class=bar>");
    ...
    @Test public void classes() {
        Document doc = Zsoup.parse("<div><p class='mellow yellow'></p><p class='red green'></p>");
    ...
    @Test public void hasText() {
        Document doc = Zsoup.parse("<div><p>Hello</p></div><div><p></p></div>");
    ...
    @Test public void html() {
        Document doc = Zsoup.parse("<div><p>Hello</p></div><div><p>There</p></div>");
        Elements divs = doc.select("div");
    ...
    @Test public void setHtml() {
        Document doc = Zsoup.parse("<p>One</p><p>Two</p><p>Three</p>");
        Elements ps = doc.select("p");
    ...
    @Test public void val() {
        Document doc = Zsoup.parse("<input value='one' /><textarea>two</textarea>");
    ...
    @Test public void before() {
        Document doc = Zsoup.parse("<p>This <a>is</a> <a>jsoup</a>.</p>");
    ...
    @Test public void empty() {
        Document doc = Zsoup.parse("<div><p>Hello <b>there</b></p> <p>now!</p></div>");
    ...
    @Test public void remove() {
        Document doc = Zsoup.parse("<div><p>Hello <b>there</b></p> jsoup <p>now!</p></div>");
        doc.outputSettings().prettyPrint(false);
    ...
    @Test public void parents() {
        Document doc = Zsoup.parse("<div><p>Hello</p></div><p>There</p>");
    ...
    @Test public void not() {
        Document doc = Zsoup.parse("<div id=1><p>One</p></div> <div id=2><p><span>Two</span></p></div>");
    ...
    @Test public void tagNameSet() {
        Document doc = Zsoup.parse("<p>Hello <i>there</i> <i>now</i></p>");
    ...
    @Test public void forms() {
        Document doc = Zsoup.parse("<form id=1><input name=q></form><div /><form id=2><input name=f></form>");
