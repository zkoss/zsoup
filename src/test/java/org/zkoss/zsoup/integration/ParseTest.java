...
public class ParseTest {
    ...
    public void testSmhBizArticle() throws IOException {
        ...
        Document doc = Zsoup.parse(in, "UTF-8",
    ...
    public void testNewsHomepage() throws IOException {
        ...
        Document doc = Zsoup.parse(in, "UTF-8", "http://www.news.com.au/");
    ...
    public void testGoogleSearchIpod() throws IOException {
        ...
        Document doc = Zsoup.parse(in, "UTF-8", "http://www.google.com/search?hl=en&q=ipod&aq=f&oq=&aqi=g10");
    ...
    public void testYahooJp() throws IOException {
        ...
        Document doc = Zsoup.parse(in, "UTF-8", "http://www.yahoo.co.jp/index.html"); // http charset is utf-8.
    ...
    public void testBaidu() throws IOException {
        ...
        Document doc = Zsoup.parse(in, null,
    ...
    public void testHtml5Charset() throws IOException {
        ...
        Document doc = Zsoup.parse(in, null, "http://example.com/"); //gb2312, has html5 <meta charset>
        ...
        doc = Zsoup.parse(in, null, "http://example.com"); // gb2312, no charset
        assertEquals("UTF-8", doc.outputSettings().charset().displayName());
        assertFalse("新".equals(doc.text()));

        // confirm fallback to utf8
        in = getFile("/htmltests/meta-charset-3.html");
        doc = Zsoup.parse(in, null, "http://example.com/"); // utf8, no charset
        assertEquals("UTF-8", doc.outputSettings().charset().displayName());
        assertEquals("新", doc.text());
    }
    ...
    public void testBrokenHtml5CharsetWithASingleDoubleQuote() throws IOException {
        InputStream in = inputStreamFrom("<html>\n" +
                ...
                "<body></body>\n" +
                "</html>");
        Document doc = Zsoup.parse(in, null, "http://example.com/");
        assertEquals("UTF-8", doc.outputSettings().charset().displayName());
    }
    ...
    public void testNytArticle() throws IOException {
        ...
        Document doc = Zsoup.parse(in, null, "http://www.nytimes.com/2010/07/26/business/global/26bp.html?hp");
    ...
    public void testYahooArticle() throws IOException {
        ...
        Document doc = Zsoup.parse(in, "UTF-8", "http://news.yahoo.com/s/nm/20100831/bs_nm/us_gm_china");
