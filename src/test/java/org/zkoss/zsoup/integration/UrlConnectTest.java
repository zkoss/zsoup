package org.zkoss.zsoup.integration;

import org.junit.Ignore;
import org.junit.Test;
import org.zkoss.zsoup.Connection;
import org.zkoss.zsoup.HttpStatusException;
import org.zkoss.zsoup.Zsoup;
import org.zkoss.zsoup.UnsupportedMimeTypeException;
...
public class UrlConnectTest {
    ...
    public void fetchURl() throws IOException {
        ...
        Document doc = Zsoup.parse(new URL(url), 10*1000);
        assertTrue(doc.title().contains("Google"));
    }

    @Test
    public void fetchURIWithWihtespace() throws IOException {
        Connection con = Zsoup.connect("http://try.jsoup.org/#with whitespaces");
    ...
    public void fetchBaidu() throws IOException {
        Connection.Response res = Zsoup.connect("http://www.baidu.com/").timeout(10*1000).execute();
    ...
    public void exceptOnUnknownContentType() {
        ...
        boolean threw = false;
        try {
            Document doc = Zsoup.parse(new URL(url), 3000);
    ...
    public void ignoresContentTypeIfSoConfigured() throws IOException {
        Document doc = Zsoup.connect("http://jsoup.org/rez/osi_logo.png").ignoreContentType(true).get();
        assertEquals("", doc.title()); // this will cause an ugly parse tree
    }

    @Test
    public void doesPost() throws IOException {
        Document doc = Zsoup.connect(echoURL)
    ...
    public void doesGet() throws IOException {
        Connection con = Zsoup.connect(echoURL + "?what=the")
            .userAgent("Mozilla")
    ...
    public void followsTempRedirect() throws IOException {
        Connection con = Zsoup.connect("http://direct.infohound.net/tools/302.pl"); // http://jsoup.org
        Document doc = con.get();
        assertTrue(doc.title().contains("jsoup"));
    }
    ...
    public void postRedirectsFetchWithGet() throws IOException {
        Connection con = Zsoup.connect("http://direct.infohound.net/tools/302.pl")
    ...
    public void followsRedirectToHttps() throws IOException {
        Connection con = Zsoup.connect("http://direct.infohound.net/tools/302-secure.pl"); // https://www.google.com
        con.data("id", "5");
        Document doc = con.get();
        assertTrue(doc.title().contains("Google"));
    }
    ...
    public void followsRelativeRedirect() throws IOException {
        Connection con = Zsoup.connect("http://direct.infohound.net/tools/302-rel.pl"); // to ./ - /tools/
    ...
    public void followsRedirectsWithWithespaces() throws IOException {
        Connection con = Zsoup.connect("http://tinyurl.com/kgofxl8"); // to http://www.google.com/?q=white spaces
        Document doc = con.get();
        assertTrue(doc.title().contains("Google"));
    }
    ...
    public void gracefullyHandleBrokenLocationRedirect() throws IOException {
        Connection con = Zsoup.connect("http://aag-ye.com"); // has Location: http:/temp/AAG_New/en/index.php
    ...
    public void throwsExceptionOnError() {
        ...
        Connection con = Zsoup.connect(url);
        boolean threw = false;
        try {
            Document doc = con.get();
    ...
    public void ignoresExceptionIfSoConfigured() throws IOException {
        Connection con = Zsoup.connect("http://direct.infohound.net/tools/404").ignoreHttpErrors(true);
        Connection.Response res = con.execute();
        Document doc = res.parse();
    ...
    public void doesntRedirectIfSoConfigured() throws IOException {
        Connection con = Zsoup.connect("http://direct.infohound.net/tools/302.pl").followRedirects(false);
        Connection.Response res = con.execute();
    ...
    public void redirectsResponseCookieToNextResponse() throws IOException {
        Connection con = Zsoup.connect("http://direct.infohound.net/tools/302-cookie.pl");
        Connection.Response res = con.execute();
    ...
    public void maximumRedirects() {
        boolean threw = false;
        try {
            Document doc = Zsoup.connect("http://direct.infohound.net/tools/loop.pl").get();
        } catch (IOException e) {
    ...
    public void multiCookieSet() throws IOException {
        ...
        Document doc = Zsoup.connect(echoURL).cookies(cookies).get();
    ...
    public void handlesDodgyCharset() throws IOException {
        ...
        Connection.Response res = Zsoup.connect(url).execute();
    ...
    public void maxBodySize() throws IOException {
        ...
        Connection.Response defaultRes = Zsoup.connect(url).execute();
        Connection.Response smallRes = Zsoup.connect(url).maxBodySize(50 * 1024).execute(); // crops
        Connection.Response mediumRes = Zsoup.connect(url).maxBodySize(200 * 1024).execute(); // crops
        Connection.Response largeRes = Zsoup.connect(url).maxBodySize(300 * 1024).execute(); // does not crop
        Connection.Response unlimitedRes = Zsoup.connect(url).maxBodySize(0).execute();
    ...
    public void shouldWorkForCharsetInExtraAttribute() throws IOException {
        Connection.Response res = Zsoup.connect("https://www.creditmutuel.com/groupe/fr/").execute();
        Document doc = res.parse(); // would throw an error if charset unsupported
    ...
    public void shouldSelectFirstCharsetOnWeirdMultileCharsetsInMetaTags() throws IOException {
        Connection.Response res = Zsoup.connect("http://aamo.info/").execute();
    ...
    public void shouldParseBrokenHtml5MetaCharsetTagCorrectly() throws IOException {
        Connection.Response res = Zsoup.connect("http://9kuhkep.net").execute();
        res.parse(); // would throw an error if charset unsupported
    ...
    public void shouldEmptyMetaCharsetCorrectly() throws IOException {
        Connection.Response res = Zsoup.connect("http://aastmultimedia.com").execute();
        res.parse(); // would throw an error if charset unsupported
        assertEquals("UTF-8", res.charset());
    }
    ...
    public void shouldWorkForDuplicateCharsetInTag() throws IOException {
        Connection.Response res = Zsoup.connect("http://aaptsdassn.org").execute();
        Document doc = res.parse(); // would throw an error if charset unsupported
        assertEquals("ISO-8859-1", res.charset());
    }
