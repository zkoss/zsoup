package org.zkoss.zsoup.safety;

import org.junit.Test;
import org.zkoss.zsoup.Zsoup;
import org.zkoss.zsoup.TextUtil;
import org.zkoss.zsoup.nodes.Document;
import org.zkoss.zsoup.nodes.Entities;
import org.zkoss.zsoup.safety.Cleaner;
import org.zkoss.zsoup.safety.Whitelist;
...
public class CleanerTest {
    @Test public void simpleBehaviourTest() {
        ...
        String cleanHtml = Zsoup.clean(h, Whitelist.simpleText());
    ...
    @Test public void basicBehaviourTest() {
        ...
        String cleanHtml = Zsoup.clean(h, Whitelist.basic());
    ...
    @Test public void basicWithImagesTest() {
        ...
        String cleanHtml = Zsoup.clean(h, Whitelist.basicWithImages());
    ...
    @Test public void testRelaxed() {
        ...
        String cleanHtml = Zsoup.clean(h, Whitelist.relaxed());
    ...
    @Test public void testIsValid() {
        ...
        assertTrue(Zsoup.isValid(ok, Whitelist.basic()));
        assertFalse(Zsoup.isValid(nok1, Whitelist.basic()));
        assertFalse(Zsoup.isValid(nok2, Whitelist.basic()));
        assertFalse(Zsoup.isValid(nok3, Whitelist.basic()));
    }
    
    @Test public void resolvesRelativeLinks() {
        String html = "<a href='/foo'>Link</a><img src='/bar'>";
        String clean = Zsoup.clean(html, "http://example.com/", Whitelist.basicWithImages());
    ...
    @Test public void preservesRelativeLinksIfConfigured() {
        ...
        String clean = Zsoup.clean(html, "http://example.com/", Whitelist.basicWithImages().preserveRelativeLinks(true));
        assertEquals("<a href=\"/foo\" rel=\"nofollow\">Link</a>\n<img src=\"/bar\"> \n<img>", clean);
    }
    
    @Test public void dropsUnresolvableRelativeLinks() {
        String html = "<a href='/foo'>Link</a>";
        String clean = Zsoup.clean(html, Whitelist.basic());
        assertEquals("<a rel=\"nofollow\">Link</a>", clean);
    }

    @Test public void handlesCustomProtocols() {
        String html = "<img src='cid:12345' /> <img src='data:gzzt' />";
        String dropped = Zsoup.clean(html, Whitelist.basicWithImages());
        assertEquals("<img> \n<img>", dropped);

        String preserved = Zsoup.clean(html, Whitelist.basicWithImages().addProtocols("img", "src", "cid", "data"));
    ...
    @Test public void handlesAllPseudoTag() {
        ...
        String clean = Zsoup.clean(html, whitelist);
    ...
    @Test public void supplyOutputSettings() {
        ...
        String customOut = Zsoup.clean(html, "http://foo.com/", Whitelist.relaxed(), os);
        String defaultOut = Zsoup.clean(html, "http://foo.com/", Whitelist.relaxed());
        ...
        String customOut2 = Zsoup.clean(html, "http://foo.com/", Whitelist.relaxed(), os);
        assertEquals("<div><p>&#x212c;</p></div>", customOut2);
    }

    @Test public void handlesFramesets() {
        String dirty = "<html><head><script></script><noscript></noscript></head><frameset><frame src=\"foo\" /><frame src=\"foo\" /></frameset></html>";
        String clean = Zsoup.clean(dirty, Whitelist.basic());
        assertEquals("", clean); // nothing good can come out of that

        Document dirtyDoc = Zsoup.parse(dirty);
