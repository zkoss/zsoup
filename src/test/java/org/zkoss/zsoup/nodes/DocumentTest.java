...
import org.zkoss.zsoup.integration.ParseTest;
...
public class DocumentTest {
    @Test public void setTextPreservesDocumentStructure() {
        Document doc = Zsoup.parse("<p>Hello</p>");
        doc.text("Replaced");
    ...
    @Test public void testTitles() {
        Document noTitle = Zsoup.parse("<p>Hello</p>");
        Document withTitle = Zsoup.parse("<title>First</title><title>Ignore</title><p>Hello</p>");
        ...
        Document normaliseTitle = Zsoup.parse("<title>   Hello\nthere   \n   now   \n");
        assertEquals("Hello there now", normaliseTitle.title());
    }

    @Test public void testOutputEncoding() {
        Document doc = Zsoup.parse("<p title=π>π & < > </p>");
        // default is utf-8
    ...
    @Test public void testXhtmlReferences() {
        Document doc = Zsoup.parse("&lt; &gt; &amp; &quot; &apos; &times;");
        doc.outputSettings().escapeMode(Entities.EscapeMode.xhtml);
        assertEquals("&lt; &gt; &amp; \" ' ×", doc.body().html());
    }

    @Test public void testNormalisesStructure() {
        Document doc = Zsoup.parse("<html><head><script>one</script><noscript><p>two</p></noscript></head><body><p>three</p></body><p>four</p></html>");
    ...
    @Test public void testClone() {
        Document doc = Zsoup.parse("<title>Hello</title> <p>One<p>Two");
    ...
    @Test public void testClonesDeclarations() {
        Document doc = Zsoup.parse("<!DOCTYPE html><html><head><title>Doctype test");
        Document clone = doc.clone();
    ...
    @Test public void testLocation() throws IOException {
        ...
        Document doc = Zsoup.parse(in, "UTF-8", "http://www.yahoo.co.jp/index.html");
        ...
        doc = Zsoup.parse(in, null, "http://www.nytimes.com/2010/07/26/business/global/26bp.html?hp");
    ...
    @Test public void testOverflowClone() {
        ...
        Document doc = Zsoup.parse(builder.toString());
        doc.clone();
    }
}
